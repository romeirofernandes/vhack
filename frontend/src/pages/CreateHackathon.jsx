            ...
            <div className="max-w-4xl mx-auto">
                ...
                >
                    <div className="flex items-center space-x-3 mb-8">
                        <div className="w-12 h-12 bg-gradient-to-br from-purple-500/20 to-purple-600/10 rounded-xl flex items-center justify-center border border-purple-500/20 backdrop-blur-sm">
                            <TbCode className="w-7 h-7 text-purple-300" />
                        </div>
                        <div>
                            <h1 className="text-3xl font-bold tracking-tight bg-gradient-to-r from-white to-zinc-400 bg-clip-text text-transparent">
                                Create New Hackathon
                            </h1>
                            <p className="text-zinc-400 mt-1">Fill in the details to create your hackathon</p>
                        </div>
                    </div>

                    <form onSubmit={handleSubmit} className="space-y-6">
                        {/* Hackathon Details Section */}
                        <Card className="bg-zinc-900/40 border-zinc-800/60 backdrop-blur-sm hover:border-zinc-700/60 transition-colors">
                            <CardHeader>
                                <CardTitle className="flex items-center space-x-2 text-lg">
                                    <div className="p-2 bg-purple-500/10 rounded-lg">
                                        <TbCode className="w-5 h-5 text-purple-300" />
                                    </div>
                                    <span className="text-white">Hackathon Details</span>
                                </CardTitle>
                            </CardHeader>
                            <CardContent className="space-y-4">
                                ...
                                <div>
                                    ...
                                    <select
                                        ...
                                        onChange={handleChange}
                                        className="w-full p-2.5 rounded-md bg-zinc-800/50 border border-zinc-700/50 text-white focus:border-purple-500/50 focus:ring-purple-500/20 focus:outline-none"
                                    >
                            ...
                            <CardHeader>
                                <CardTitle className="flex items-center space-x-2 text-lg">
                                    <div className="p-2 bg-blue-500/10 rounded-lg">
                                        <TbCalendar className="w-5 h-5 text-blue-300" />
                                    </div>
                                    <span className="text-white">Timelines</span>
                                </CardTitle>
                            </CardHeader>
                            <CardContent>
                            ...
                            <CardHeader>
                                <CardTitle className="flex items-center space-x-2 text-lg">
                                    <div className="p-2 bg-green-500/10 rounded-lg">
                                        <TbUsers className="w-5 h-5 text-green-300" />
                                    </div>
                                    <span className="text-white">Team Settings</span>
                                </CardTitle>
                            </CardHeader>
                            <CardContent>
                                <div className="space-y-4">
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <Input
                                                ...
                                                min="1"
                                                required
                                                className="bg-zinc-800/50 border-zinc-700/50 text-white focus:border-green-500/50 focus:ring-green-500/20"
                                            />
                                        </div>
                                        <div>
                                    ...
                                    <div className="flex items-center space-x-2">
                                        <input
                                            ...
                                            onChange={handleChange}
                                            className="w-4 h-4 rounded border-zinc-700/50 bg-zinc-800/50 text-green-500 focus:ring-green-500/20 focus:ring-offset-zinc-900"
                                        />
                            ...
                            <CardHeader>
                                <CardTitle className="flex items-center space-x-2 text-lg">
                                    <div className="p-2 bg-yellow-500/10 rounded-lg">
                                        <TbTrophy className="w-5 h-5 text-yellow-300" />
                                    </div>
                                ...
                                <div className="space-y-4">
                                    <div>
                                        ...
                                        <Input
                                            ...
                                            className="bg-zinc-800/50 border-zinc-700/50 text-white placeholder:text-zinc-500 focus:border-yellow-500/50 focus:ring-yellow-500/20"
                                        />
                                    </div>
                                    <div>
                        ...
                        <div className="flex justify-end">
                            <Button
                                type="submit"
                                disabled={loading}
                                className="bg-gradient-to-r from-purple-500 to-purple-600 text-white hover:from-purple-600 hover:to-purple-700 disabled:opacity-50 px-8 py-2.5 rounded-lg font-medium transition-all duration-200"
                            >
