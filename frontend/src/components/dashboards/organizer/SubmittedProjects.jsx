    ...
    return (
      <div className="min-h-screen bg-zinc-950 flex items-center justify-center">
        <div className="text-center">
          ...
          <div className="text-white text-sm sm:text-base">Loading submitted projects...</div>
        </div>
      </div>
    );
  }
        ...
        >
          <div className="flex flex-col sm:flex-row items-start sm:items-center space-y-2 sm:space-y-0 sm:space-x-4">
            <Button
              onClick={onBack}
              variant="outline"
              className="text-zinc-800 hover:bg-zinc-800 hover:text-white text-xs sm:text-sm"
            >
              <TbArrowLeft className="w-4 h-4 mr-2" />
              Back to Hackathon
            </Button>
            <div>
              <h1 className="text-xl sm:text-3xl font-bold text-white mb-1">Submitted Projects</h1>
              <p className="text-zinc-400 text-xs sm:text-base">{hackathon.title}</p>
            </div>
          </div>
          <Badge className="bg-blue-600 text-white border border-blue-500 text-xs sm:text-sm">
        ...
        >
          <Card className="bg-zinc-950 border-zinc-800">
            <CardContent className="p-3 sm:p-4 text-center">
              ...
              <div className="text-zinc-400 text-xs sm:text-sm">Total Submissions</div>
            </CardContent>
          </Card>
          <Card className="bg-zinc-950 border-zinc-800">
            <CardContent className="p-3 sm:p-4 text-center">
              ...
              <div className="text-zinc-400 text-xs sm:text-sm">Awaiting Review</div>
            </CardContent>
          </Card>
          <Card className="bg-zinc-950 border-zinc-800">
            <CardContent className="p-3 sm:p-4 text-center">
              ...
              <div className="text-zinc-400 text-xs sm:text-sm">Under Review</div>
            </CardContent>
          </Card>
          <Card className="bg-zinc-950 border-zinc-800">
            <CardContent className="p-3 sm:p-4 text-center">
        ...
        >
          <div className="flex-1">
            <div className="relative">
              ...
              <Input
                ...
                className="pl-10 bg-zinc-900 border-zinc-800 text-white placeholder-zinc-400 text-xs sm:text-sm h-9 sm:h-10"
              />
            </div>
          </div>
          <div className="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
            <select
              ...
              className="px-2 sm:px-3 py-2 bg-zinc-900 border border-zinc-800 rounded-md text-white text-xs sm:text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
            >
          ...
          {filteredProjects.length === 0 ? (
            <Card className="bg-zinc-950 border-zinc-800">
              <CardContent className="p-8 sm:p-12 text-center">
                <MdAssignment className="w-10 h-10 sm:w-16 sm:h-16 text-zinc-600 mx-auto mb-4" />
