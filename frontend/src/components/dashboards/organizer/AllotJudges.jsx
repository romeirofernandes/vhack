      ...
      <div className="max-w-6xl mx-auto px-6 py-8 space-y-8">
        ...
        >
          ...
          <div className="text-center space-y-3 mb-12">
            <h1 className="text-4xl font-bold text-white">Invite Judges</h1>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-8">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="text-white font-medium">Accepted</div>
                  ...
                  {hackathonData.invitedJudges?.length > 0 && (
                    <Badge className="bg-yellow-600/20 text-yellow-400 border-yellow-600/30 px-3 py-1">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                  ...
                  <div className="flex gap-4">
                    <div className="relative flex-1">
                      <Input
                        ...
                        className="bg-white/5 border-white/10 text-white placeholder:text-white/50 h-12 pl-12"
                      />
                      <TbSearch className="absolute left-4 top-1/2 transform -translate-y-1/2 w-5 h-5 text-white/50" />
                    </div>
                    <Button
                ...
                <CardContent className="space-y-4">
                  {isLoading ? (
                    <div className="text-center py-12">
                      ...
                      <p className="text-white/70">Searching for judges...</p>
                    </div>
                  ) : filteredJudges.length === 0 ? (
                    <div className="text-center py-12">
                      <TbUsers className="w-12 h-12 text-white/30 mx-auto mb-4" />
                      ...
                      {filteredJudges.map((judge) => (
                        ...
                        >
                          <div className="flex items-center gap-4">
                            <div className="w-12 h-12 rounded-full bg-blue-600/20 border-2 border-blue-600/30 flex items-center justify-center">
                          ...
                          <Button
                            ...
                            className="bg-green-600 text-white hover:bg-green-700 disabled:opacity-50 disabled:cursor-not-allowed h-10 px-6"
                          >
            ...
            <div className="lg:col-span-1">
              <Card className="bg-zinc-950 border-white/10 sticky top-6">
                <CardHeader>
                  <CardTitle className="text-white text-xl">
                    Invitation Guide
                  </CardTitle>
                ...
                <CardContent className="space-y-6">
                  <div className="space-y-4 text-white/70">
                    ...
                    {hackathonData && (
                      <div className="bg-green-600/10 p-4 rounded-lg border border-green-600/20 space-y-2">
